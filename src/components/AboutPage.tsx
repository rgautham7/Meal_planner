...
export function AboutPage() {
  return (
    <div className="min-h-screen w-full dark:bg-black bg-white dark:bg-dot-white/[0.2] bg-dot-black/[0.2] relative flex items-center justify-center px-4 md:px-6 py-12 md:py-20">
      <div className="absolute pointer-events-none inset-0 flex items-center justify-center dark:bg-black bg-white [mask-image:radial-gradient(ellipse_at_center,transparent_20%,black)]"></div>

      <div className="relative z-20 text-center max-w-6xl mx-auto">
        <h1 className="text-3xl md:text-5xl lg:text-7xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-green-400 to-blue-500 mb-4 md:mb-6">
          Your Personal Meal Planner
        </h1>
        <p className="text-base md:text-lg lg:text-2xl text-gray-700 dark:text-gray-300 mb-6 md:mb-8">
        ...
        <div className="flex justify-center">
          <MovingBorderButton
            ...
            className="text-lg md:text-xl font-bold h-12 md:h-16 w-40 md:w-48 bg-white dark:bg-slate-900 text-black dark:text-white border-neutral-200 dark:border-slate-800"
          >
            Get Started
          </MovingBorderButton>
        </div>
